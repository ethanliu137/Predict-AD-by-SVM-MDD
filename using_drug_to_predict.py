...
def plot_learning_curve(estimator, X, y, title): #學習曲線
...
X_train, X_test, y_train, y_test = train_test_split(
    X, y, test_size=0.2, random_state=seed, stratify=y['remissionv41_LOCF'])

# ==== 訓練資料 ====
base_model = make_pipeline(MinMaxScaler(), SVC(kernel=ker, random_state=seed))
param_grid = {
    'estimator__svc__C': [0.9],
